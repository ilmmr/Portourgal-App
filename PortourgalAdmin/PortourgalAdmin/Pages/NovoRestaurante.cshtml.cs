...
{
    public class NovoRestauranteModel : PageModel
    {
        ...
        public ActionResult OnPost(string ascii, string cid)
        {
            ...
            Restaurante r = new Restaurante(nome, morada, classificacao, imagem);
            AddRestaurante(ascii, cid, r);
            return new RedirectToPageResult("/Cidade", new { nome = cid, dascii = ascii });
        }

        public async void AddRestaurante(string ascii, string cid, Restaurante r)
        {
